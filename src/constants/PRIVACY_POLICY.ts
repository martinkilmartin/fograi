const PrivacyPolicy = [
  ...
  },
  {
    ...
    content: [
      ...
      `We will only use your personal data for a purpose it was collected for or a reasonably compatible purpose if necessary. For more information on this please email us at ${process.env.NEXT_PUBLIC_EMAIL_ADDRESS_PRIVACY}. In case we need to use your details for an unrelated new purpose we will let you know and explain the legal grounds for processing.`,
  ...
  },
  {
    ...
    content: [
      ...
      `You can ask us or third parties to stop sending you marketing messages at any time by following the opt-out links on any marketing message sent to you or by emailing us at ${process.env.NEXT_PUBLIC_EMAIL_ADDRESS_PRIVACY} at any time.`,
  ...
  },
  {
    title: '🍪 10. COOKIES  ',
    content: [
      `You can set your browser to refuse all or some browser cookies, or to alert you when websites set or access cookies. If you disable or refuse cookies, please note that some parts of this website may become inaccessible or not function properly. For more information about the cookies we use, please see ${process.env.NEXT_PUBLIC_URL_COOKIE}.`,
    ],
  },
]

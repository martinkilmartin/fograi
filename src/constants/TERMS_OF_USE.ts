const TermsOfUse = [
  ...
  {
    title: '📨 4. If we need to talk to you',
    content: [
      'From time to time, we might need to contact you about your user account. We’ll normally do that over email, which is why we need a valid email address from you if you agree to make a user account through the website.',
    ],
  },
  {
  ...
  {
    title: '↙ 10. Links from third party websites',
    content: [
